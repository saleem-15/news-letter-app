...
class ManagerColors {
  ...
  static const Color textSecondryColor = Color(0xff6D6265);
  ...
  static const Color splashViewBackgroundColor = Color(0xffE9EEFA);

  static const Color indigo = Color(0xff2D5BD0);

  static const Color onBoardingGradientStartColor = Color(0xff2249D4);
  static const Color onBoardingGradientEndColor = Color(0xffE9EEFA);
}
